/**
 * Created by mattlam on 4/16/2016.
 */
        ...
        new LocalStrategy(
            ...
            function(req, username, password, done) {
                ...
                function findOrCreateUser() {
                    ...
                    // Find a user in DB with givne username
                    User.findOne(
                        { 'username': username },
                        function(err, user) {
                ...
                // Delay the execution fo findOrCreateUser and execute the
